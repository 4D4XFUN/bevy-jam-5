...
fn on_death_spawn_new_ghost(
    ...
    frames.insert(PlayerAnimationState::FrontIdling, (0, 4, Duration::from_millis(500)));
    frames.insert(PlayerAnimationState::FrontWalking, (7, 4, Duration::from_millis(500)));
    frames.insert(PlayerAnimationState::FrontRolling, (14, 7, Roll::ROLL_TIME / 7));
    frames.insert(PlayerAnimationState::Idling, (21, 4, Duration::from_millis(500)));
    frames.insert(PlayerAnimationState::Walking, (28, 4, Duration::from_millis(500)));
    frames.insert(PlayerAnimationState::Walking, (35, 7, Duration::from_millis(500)));
